  ...
  return (
    <>
      ...
      <PageHero
        ...
        backdrop={<SceneFrame variant="solutions-hub" />}
      >
        <p data-reveal data-reveal-load data-reveal-delay="100">Your problem is unique. Your digital solution should be too.</p>
        <p data-reveal data-reveal-load data-reveal-delay="200">
        ...
        <div className="page-hero-cta" data-reveal data-reveal-load data-reveal-delay="300">
      ...
      <Section className="section-head">
        ...
        <h2 className="section-title" data-split>Built for Organizations With Problems Worth Solving.</h2>
      </Section>
      <div className="container" data-reveal>
        ...
        <p className="body" style={{ marginTop: '1.5rem' }}>
          <a href="/solutions" data-roll-link>Explore all digital solutions</a>
        </p>
      </div>
      ...
      <Section className="section-head">
        ...
        <h2 className="section-title" data-split>What We Build.</h2>
      </Section>
      ...
      <section className="section cta-band">
        <div className="container" data-reveal>
          <h2 className="h2" data-lines>{SOLUTIONS_HUBS.serviceCtaTitle}</h2>
